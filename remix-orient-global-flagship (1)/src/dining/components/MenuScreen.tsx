    ...
    <div className="bg-background min-h-screen text-foreground font-sans selection:bg-primary selection:text-background pb-32">
      ...
      <header id="hero-dining" className="relative h-screen min-h-[100dvh] w-full overflow-hidden flex flex-col items-center justify-center">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 from-background via-black/35 to-black/60"></div>
        </div>
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center justify-center h-full pt-16">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-transparent text-[#F29E0D] font-black text-xs uppercase tracking-widest hover:bg-[#F29E0D] hover:text-[ffffff] transition-all duration-300 active:scale-95"
          >
            <span className="hover:text-white"> Browse Menu</span>
            <span className="material-icons text-sm hover:text-white">arrow_downward</span>
          </a>
        </div>
      </header>
      ...
      <div className="relative">
        ...
        {/* ========================================================= */}
        {/* CATEGORY BAR (STATIC) & SEARCH (STICKY)                 */}
        {/* ========================================================= */}
        ...
        <div className="sticky top-[20px] lg:top-[70px] z-40 w-full pointer-events-none mt-4">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 pb-4 border-b border-transparent gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-semibold transition-colors ${sommelierFilter === "all" ? "bg-primary text-background" : "bg-white/10 text-white/80 hover:bg-white/15"
                  }`}
              >
                All 5 Drinks
              </button>
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-semibold transition-colors ${sommelierFilter === "local" ? "bg-primary text-background" : "bg-white/10 text-white/80 hover:bg-white/15"
                  }`}
              >
                Local Botanicals
              </button>
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-semibold transition-colors ${sommelierFilter === "wine" ? "bg-primary text-background" : "bg-white/10 text-white/80 hover:bg-white/15"
                  }`}
              >
                Grand Cru Wine
              </button>
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-semibold transition-colors ${sommelierFilter === "cocktail" ? "bg-primary text-background" : "bg-white/10 text-white/80 hover:bg-white/15"
                  }`}
              >
                Signature Chapman
              </button>
